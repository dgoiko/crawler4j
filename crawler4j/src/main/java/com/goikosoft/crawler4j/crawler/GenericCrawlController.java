...
public class GenericCrawlController<CrawlerType extends GenericWebCrawler<? extends ResultType>, ResultType> {
     ...
     */
    public <T extends CrawlerType> void start(Class<T> clazz, int numberOfCrawlers) {
     ...
     * @param <T> Your class extending WebCrawler
     */
    public <T extends CrawlerType> void start(T instance) {
     ...
     * @param <T> Your class extending WebCrawler
     */
    public <T extends CrawlerType> void start(WebCrawlerFactory<T> crawlerFactory,
     ...
     * @param <T> Your class extending WebCrawler
     */
    public <T extends CrawlerType> void startNonBlocking(WebCrawlerFactory<T> crawlerFactory,
     ...
     * @param <T> Your class extending WebCrawler
     */
    public <T extends CrawlerType> void startNonBlocking(Class<T> clazz, int numberOfCrawlers) {

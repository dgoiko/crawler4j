...
import com.goikosoft.crawler4j.crawler.exceptions.ContentFetchException;
...
public class GenericWebCrawler<ResultType> implements Runnable {
     ...
     */
    protected GenericCrawlController<?, ? super ResultType> myController;
     ...
     */
    public void init(int id, GenericCrawlController<?, ? super ResultType> crawlController)
    ...
    public GenericCrawlController<?, ? super ResultType> getMyController() {
        return myController;
    }
     ...
     */
    public ResultType getMyLocalData() {
        return null;
    }
